...
A Klipper (or Kalico) macro for testing printer motion systems, including full axis testing and isolated CoreXY motor diagnostics.
...
1.  Copy the macro into your Klipper config.
2.  Restart Klipper.
...
SPEED: Movement speed in mm/min. Defaults: - XY/A/B = 6000 - Z = 600
